...
//   return (
//      <h1>this is edit blog post page</h1>
//   );
// };
...
class EditBlog extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .get(`/api/server/posts/${this.props.match.params.id}`)
            .then((post) => {
                this.setState({
    ...
    handleSubmit(event) {
        ...
        axios
            .post(
                `/api/server/posts/edit/${this.props.match.params.id}`,
                editedPost
            )
            .then(
            ...
            return (
                <div className="container">
                    ...
                    {this.state.title ==="" ? (
                          ...
                          style={{ display: "block",position:"absolute",top:"40%",left:"47%" }}
                      >
